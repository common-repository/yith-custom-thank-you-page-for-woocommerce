...
<p>
	<?php
		esc_html_e( 'Unfortunately your order cannot be processed as the originating bank/merchant has declined your transaction.', 'yith-custom-thank-you-page-for-woocommerce' );
	?>
</p>
...
<p>
	<a href="<?php echo esc_url( $order->get_checkout_payment_url() ); ?>" class="button pay">
		<?php esc_html_e( 'Pay', 'yith-custom-thank-you-page-for-woocommerce' ); ?>
	</a>
